...
def api_change_username():
    ...
    try:
        ...
        # Для Neon PostgreSQL: обновляем объект из БД
        db.refresh(user)
        
        print(f"✅ change-username: успешно! id={user.id}, старый ник='{old_username}', новый ник='{user.username}'")

        # Возвращаем новый username
