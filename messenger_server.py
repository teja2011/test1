...
@app.route('/api/users/last-messages')
def api_users_last_messages():
    """
    ...
    db = get_db()
    try:
        # Получаем всех пользователей, с которыми были переписки
        # (кто отправлял нам сообщения или кому мы отправляли)
